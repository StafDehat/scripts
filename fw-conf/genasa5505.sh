...
echo "Welcome!  Let's configure an asa5505!"
echo "(Not a 5505?  Probably don't want this guide)"
echo ""
...
echo ""
echo -e "\033[1mPrepare thyself for an initial asa5505 config\033[0m"
...
echo "http `echo $INTC | cut -d. -f1,2`.0.0 255.255.0.0 inside"
...
echo "ssh 74.200.242.106 255.255.255.255 outside" #For RANCID
echo "ssh `echo $INTC | cut -d. -f1,2`.0.0 255.255.0.0 inside"
